...
int main(int argc, char* argv[]) {
    if (argc != 3) {
        ...
        cerr << "Output: <input.h264>.s2_hybrid (encrypted file)\n";
        cerr << "        <input.h264>.s2_hybrid.meta (metadata with padding)\n";
        return 1;
    }

    string input_file = argv[1];
    string key_str = argv[2];
    string output_file = input_file + ".s2_hybrid";
    string metadata_file = input_file + ".s2_hybrid.meta";
    ...
    cout << "📋 Mode: I-frames only - Strategy 2\n";
    ...
    // Encrypt DC components - I-frames ONLY
    ...
    for (size_t i = 0; i < nalu_positions.size(); i++) {
        ...
        // Only encrypt I-frames (IDR = 5, or I-slice = 2)
    ...
    cout << "  🎬 I-frames encrypted: " << encrypted_count << "\n";
    cout << "  ⏭️  P/B frames skipped: " << p_b_frame_count << "\n";
