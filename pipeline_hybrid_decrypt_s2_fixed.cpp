...
int main(int argc, char* argv[]) {
    if (argc != 3) {
        cerr << "Usage: " << argv[0] << " <encrypted.h264.s2_hybrid_fixed> <key>\n";
        return 1;
    }
    ...
    if (string(magic, 4) != "S2FX") {
        cerr << "❌ Error: Metadata not for S2\n";
        return 1;
    }
    ...
    cout << "🔑 Key: " << key_str << "\n";
    cout << "📊 Strategy: HYBRID fixed S2 (Type 5 only, using metadata)\n";
    ...
    cout << "\n🔐 Processing Decryption (S2: Type 5 only)...\n";
