...
int main(int argc, char* argv[]) {
    ...
    string results_dir     = "results/" + video_basename + "/" + algo_name + "_s1";
    string suffix          = (algo_name == "hybrid") ? ".s1_hybrid_fixed" : ".s1_" + algo_name;
    ...
    cout << "📊 Strategy: S1 (Type 1 P/B + Type 5 I-frames)\n";
    ...
    dc_txt << "# NALU DC dump (before encryption) - S1 - Algo: " << algo_name << "\n";
    ...
    for (size_t i = 0; i < nalus.size(); i++) {
        ...
        encrypted_count++;
        if (i % 5000 == 0 && i > 0) cout << "  Processed " << i << " NALUs...\n";
    }
    ...
    cout << "\n✅ Encryption complete! (" << algo_name << " S1)\n";
