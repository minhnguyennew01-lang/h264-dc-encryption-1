...
\begin{tikzpicture}[
  box/.style={draw, minimum height=0.75cm, text centered, font=\small, align=center},
...
\node[box, right=0pt of idt, fill=gray!20, minimum width=1.4cm, align=center] (hdr18) {Header\\1–18};
\node[box, right=0pt of hdr18, fill=orange!40, minimum width=2.0cm] (dc25) {\textbf{DC (25 bytes)}\newline};
\node[box, right=0pt of dc25, fill=blue!10, minimum width=1.6cm, align=center] (rem) {Remain\\payload};
...
%% Legend
\node[vcl, minimum width=0.6cm, minimum height=0.4cm, yshift=-10mm] (leg1) at (0,-3.4) {};
\node[right=2pt of leg1, font=\footnotesize, anchor=west] (leg1text) {VCL (Type 1, 5) — được mã hoá};

% Place the 2nd legend entry after the 1st legend text to avoid overlap
\node[nonvcl, minimum width=0.6cm, minimum height=0.4cm, right=10pt of leg1text.east, anchor=west] (leg2) {};
\node[right=2pt of leg2, font=\footnotesize, anchor=west] {Non-VCL (SPS, PPS) — không mã hoá};
